...
1) Grundsatz Unmittelbarkeit (§ 57 Abs. 1 AO)
...
<!-- keywords: \u00A7\s*57\s*abs\.?\s*3|servicegesell|planm\u00E4\u00DFiges zusammenwirken|kostenteilungsgemeinschaft|\u00A7\s*4\s*nr\.?\s*29|arbeitsteilige gemeinn -->
