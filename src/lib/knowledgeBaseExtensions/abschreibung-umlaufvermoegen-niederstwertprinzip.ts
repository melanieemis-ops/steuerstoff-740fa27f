...
export const abschreibungUmlaufvermoegenNiederstwertprinzip: KBEntry = {
  id: "abschreibung-umlaufvermoegen-niederstwertprinzip",
  title: "Abschreibung des Umlaufvermögens: strenges Niederstwertprinzip und beizulegender Wert",
  short:
  ...
  keywords:
    "abschreibung umlaufvermögen|strenges niederstwertprinzip|§ 253 abs. 4 hgb|börsenpreis|marktpreis|beizulegender wert|beschaffungsmarkt|absatzmarkt|wiederbeschaffungskosten|retrograde bewertung|verlustfreie bewertung|teilwert umlaufvermögen|vorratsbewertung|wertpapiere umlaufvermögen",
  references: [
    "§ 253 Abs. 4 HGB",
    "§ 252 Abs. 1 Nr. 4 HGB",
    "§ 5 Abs. 1 EStG",
  ...
  importance: 5,
  body: `Bei Vermögensgegenständen des Umlaufvermögens gilt handelsrechtlich das strenge Niederstwertprinzip. Ausgangspunkt und Wertobergrenze sind die Anschaffungs- oder Herstellungskosten. Liegt der am Abschlussstichtag maßgebliche Wert darunter, muss zwingend auf den niedrigeren Wert abgeschrieben werden.
...
1. Gehört der Vermögensgegenstand zum Umlaufvermögen?
2. Wie hoch sind die Anschaffungs- oder Herstellungskosten?
3. Gibt es einen Börsenpreis?
4. Falls nein: Gibt es einen Marktpreis?
5. Falls nein: Welcher Wert ist beizulegen?
6. Ist Beschaffungs- oder Absatzmarkt maßgeblich?
7. Liegt der ermittelte Wert unter den Anschaffungs- oder Herstellungskosten?
8. Falls ja: zwingende Abschreibung auf den niedrigeren Wert.
...
KNOWLEDGE_BASE.push(abschreibungUmlaufvermoegenNiederstwertprinzip);
