...
export const aoSchaetzungBesteuerungsgrundlagenVerfahrensrecht: KBEntry = {
  id: "ao-schaetzung-besteuerungsgrundlagen-verfahrensrecht",
  title: "Schätzung von Besteuerungsgrundlagen nach § 162 AO: Verfahrensrecht und richtige Reaktion",
  short:
  ...
  keywords:
    "schätzung besteuerungsgrundlagen|schätzungsbescheid|§ 162 ao|steuererklärung nicht abgegeben|vollschätzung|teilschätzung|sicherheitszuschlag|richtsatzsammlung|nachkalkulation|externer betriebsvergleich|innerer betriebsvergleich|einspruch schätzungsbescheid|aussetzung vollziehung|§ 361 ao|vorbehalt nachprüfung|§ 164 ao|ausschlussfrist|§ 364b ao|bestandskraft|§ 173 ao|nichtigkeit schätzungsbescheid|straf-schätzung|strafsschätzung|willkürliche schätzung|§ 125 ao|feststellung nichtigkeit",
  references: [
    "§ 88 AO",
    "§ 125 AO",
    "§ 149 AO",
...
1. Wann wurde der Bescheid bekannt gegeben?
2. Läuft die einmonatige Einspruchsfrist noch?
3. Steht der Bescheid unter dem Vorbehalt der Nachprüfung?
4. Welche Besteuerungsgrundlagen wurden geschätzt?
5. Welche vorhandenen Daten hat das Finanzamt berücksichtigt oder übergangen?
6. Ist die Schätzungsmethode nachvollziehbar?
7. Ist ein Sicherheitszuschlag sachlich begründet?
8. Kann die fehlende Erklärung sofort nachgereicht werden?
9. Soll Aussetzung der Vollziehung beantragt werden?
10. Wurde eine Ausschlussfrist nach § 364b AO gesetzt?
11. Ist der Bescheid nur rechtswidrig und anfechtbar oder ausnahmsweise nichtig?
...
if (!KNOWLEDGE_BASE.some((entry) => entry.id === aoSchaetzungBesteuerungsgrundlagenVerfahrensrecht.id)) {
  KNOWLEDGE_BASE.push(aoSchaetzungBesteuerungsgrundlagenVerfahrensrecht);
}
