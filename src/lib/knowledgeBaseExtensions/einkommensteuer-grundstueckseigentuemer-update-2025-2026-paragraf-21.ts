...
export const grundstueckseigentuemerUpdate20252026Paragraf21: KBEntry = {
  id: "einkommensteuer-grundstueckseigentuemer-update-2025-2026-paragraf-21",
  title: "Besteuerung von Grundstückseigentümern – Update 2025/2026 zu § 21 EStG",
  short:
  ...
  keywords:
    "§ 21 estg|vermietung und verpachtung|grundstückseigentümer|§ 7b estg|neue wohnung|ferienwohnung|einkünfteerzielungsabsicht|blockheizkraftwerk|bhkw|zinsswap|vorausfälligkeitsentschädigung|vorfälligkeitsentschädigung|schuldzinsen|teilübertragung|schenkung|miteigentumsanteil|werbungskosten",
  references: [
    "§ 21 EStG",
    "§ 7b EStG",
    ...
    "BFH, Urteil vom 12.8.2025 – IX R 23/24",
    "BFH, Urteil vom 19.11.2024 – VIII R 26/21",
    "BFH, Urteil vom 3.12.2024 – IX R 2/24",
    "FG Berlin-Brandenburg, Urteil vom 9.4.2025 – 16 K 16145/23",
    "FG Hamburg, Urteil vom 16.10.2025 – 3 K 53/23",
    "FG Niedersachsen, Urteil vom 30.10.2024 – 3 K 145/23",
  ],
  importance: 5,
  body: `Die Rechtsprechung 2024 bis 2025 hat mehrere praxisrelevante Fragen bei den Einkünften aus Vermietung und Verpachtung konkretisiert. Im Mittelpunkt stehen die Sonderabschreibung für neue Mietwohnungen, die Einkünfteerzielungsabsicht bei Ferienwohnungen, die Zuordnung technischer Anlagen sowie der Werbungskostenabzug bei Finanzierungsmaßnahmen und Übertragungen.
...
1. Welche Einkunftsquelle liegt vor und besteht sie fort?
2. Gehört die Maßnahme wirtschaftlich zur Vermietung oder zu einer anderen Einkunftsart?
3. Bei § 7b EStG: Wurde der Wohnungsbestand tatsächlich vermehrt?
4. Bei Ferienwohnungen: Liegt die Auslastung über drei bis fünf Jahre höchstens 25 % unter dem Ortsüblichen?
5. Bei Finanzierungsinstrumenten: Besteht eine konkrete Verknüpfung mit einem bestimmten Immobiliendarlehen?
6. Bei Vorfälligkeitsentschädigungen: Wird das finanzierte Objekt weiter vermietet oder veräußert?
7. Bei Übertragungen: Wer trägt Schuld und Zinsen nach der Übertragung?
8. Führt eine Schuldübernahme zu Teilentgeltlichkeit und gegebenenfalls zu § 23 EStG?
...
KNOWLEDGE_BASE.push(grundstueckseigentuemerUpdate20252026Paragraf21);
