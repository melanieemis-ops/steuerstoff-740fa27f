...
export const einkommensteuerParagraf6EstgBewertung: KBEntry = {
  ...
  title: "§ 6 EStG: Bewertung von Wirtschaftsgütern, Rückstellungen, Entnahmen und Einlagen",
  short:
  ...
  paragraphNumber: 6,
  source:
    "Zusammenfassung des vom Nutzer bereitgestellten Gesetzestextes zu § 6 EStG; Rechtsstand des bereitgestellten Materials vom 30.07.2026.",
  keywords:
    "§ 6 estg|6 estg|bewertung|wirtschaftsgüter|wirtschaftsgueter|anlagevermögen|anlagevermoegen|umlaufvermögen|umlaufvermoegen|anschaffungskosten|herstellungskosten|teilwert|teilwertabschreibung|dauernde wertminderung|anschaffungsnahe herstellungskosten|rückstellungen|rueckstellungen|abzinsung 5,5 prozent|entnahme|einlage|private kfz-nutzung|1-prozent-regelung|fahrtenbuch|elektrofahrzeug|gwg|geringwertige wirtschaftsgüter|sammelposten|buchwertübertragung|buchwertuebertragung|mitunternehmeranteil|sperrfrist|tausch|verdeckte einlage",
  references: [
    "§ 6 EStG",
    "§ 4 Abs. 1 EStG",
    "§ 5 EStG",
  ...
  importance: 5,
  body: `§ 6 EStG ist die zentrale steuerliche Bewertungsvorschrift für Wirtschaftsgüter und Schulden des Betriebsvermögens.
...
1. Welches Wirtschaftsgut oder welche Schuld ist zu bewerten?
2. Gehört der Posten zum Anlage- oder Umlaufvermögen?
3. Was ist der gesetzliche Ausgangswert?
4. Liegt eine dauernde Wertminderung vor?
5. Greift ein besonderer Wertansatz für Rückstellungen, Entnahmen oder Einlagen?
6. Ist eine GWG- oder Sammelpostenregelung anwendbar?
7. Liegt eine Buchwertübertragung vor?
8. Müssen Sperr- oder Behaltefristen überwacht werden?
...
if (!KNOWLEDGE_BASE.some((entry) => entry.id === einkommensteuerParagraf6EstgBewertung.id)) {
  KNOWLEDGE_BASE.push(einkommensteuerParagraf6EstgBewertung);
}
