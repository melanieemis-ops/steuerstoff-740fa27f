...
export const erbschaftsteuerFamilienheimEigennutzungRueckforderungsrechte: KBEntry = {
  id: "erbschaftsteuer-familienheim-eigennutzung-rueckforderungsrechte",
  title: "Familienheim: Eigennutzung im Erbfall und Gestaltung mit Rückforderungsrechten",
  short:
  ...
  keywords:
    "familienheim|eigennutzung familienheim|zehn jahre selbstnutzung|nachversteuerung familienheim|§ 13 abs. 1 nr. 4b erbstg|§ 13 abs. 1 nr. 4c erbstg|vorversterbensklausel|rückforderungsrecht schenkung|widerrufsvorbehalt|nießbrauch familienheim|wohnrecht familienheim|§ 29 erbstg|berliner testament|200 qm kinder|fallbeilmethode",
  references: [
    "§ 13 Abs. 1 Nr. 4a bis 4c ErbStG",
    "§ 29 Abs. 1 Nr. 1 und Abs. 2 ErbStG",
    "§ 15 Abs. 2 BewG",
    "R E 13.4 Abs. 6 ErbStR 2019",
    "FG Baden-Württemberg, Urteil vom 11.05.2022 – 7 K 1550/20",
  ],
  importance: 5,
  body: `Die Steuerbefreiung für das Familienheim kann beim Erwerb von Todes wegen erhebliche Vorteile bieten. Gleichzeitig ist sie an strenge Voraussetzungen geknüpft. Besonders wichtig sind die unverzügliche Aufnahme der Selbstnutzung und deren Fortführung über zehn Jahre.
...
1. Liegt ein begünstigtes Familienheim vor?
2. Erfolgt der Erwerb unter Lebenden oder von Todes wegen?
3. Welche Befreiungsvorschrift ist einschlägig: § 13 Abs. 1 Nr. 4a, 4b oder 4c ErbStG?
4. Wurde die Selbstnutzung unverzüglich aufgenommen?
5. Ist bei Kindern die Grenze von 200 Quadratmetern zu beachten?
6. Wird die Selbstnutzung zehn Jahre fortgeführt?
7. Liegt bei vorzeitiger Aufgabe ein objektiv zwingender Grund vor?
8. Soll eine lebzeitige Übertragung mit Rückforderungsrecht erfolgen?
9. Welche Rückforderungsgründe sollen vereinbart werden?
10. Soll ein Nießbrauchs- oder Wohnrecht vorbehalten werden?
11. Ist eine Rückauflassungsvormerkung vorgesehen?
12. Welche sozialhilferechtlichen, zivilrechtlichen und pflichtteilsrechtlichen Folgen entstehen?

Praxishinweis:
Die Übertragung eines Familienheims mit Rückforderungs-, Widerrufs-, Nießbrauchs- oder Wohnrechtsvorbehalten ist zivilrechtlich und steuerlich anspruchsvoll. Vor Vertragsabschluss sollten insbesondere die erbschaftsteuerlichen, sozialhilferechtlichen, güterrechtlichen und pflichtteilsrechtlichen Folgen durch hierzu befugte Rechts- und Steuerberater geprüft werden.`
};

KNOWLEDGE_BASE.push(
  erbschaftsteuerFamilienheimEigennutzungRueckforderungsrechte,
);
