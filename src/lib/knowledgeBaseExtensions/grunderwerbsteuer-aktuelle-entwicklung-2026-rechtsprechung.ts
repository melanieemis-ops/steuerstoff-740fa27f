...
export const grunderwerbsteuerAktuelleEntwicklung2026Rechtsprechung: KBEntry = {
  id: "grunderwerbsteuer-aktuelle-entwicklung-2026-rechtsprechung",
  title: "Aktuelle Entwicklung in der Grunderwerbsteuer 2026: Praxisrelevante Rechtsprechung",
  short:
  ...
  keywords:
    "grunderwerbsteuer 2026|§ 6a grestg|konzernklausel|vorbehaltensfrist|nachbehaltensfrist|§ 23 abs. 18 grestg|§ 23 abs. 24 grestg|einheitlicher erwerbsgegenstand|bauerrichtungsvertrag|baukosten grunderwerbsteuer|§ 16 abs. 3 grestg|dingliche nutzungsrechte|nießbrauch grunderwerbsteuer|wohnungsrecht|§ 9 grestg|rückgängigmachung|widerrufsrecht|anteilsvereinigung|share deal|rett blocker",
  references: [
  ...
  importance: 5,
  body: `Die Grunderwerbsteuer ist längst nicht mehr nur bei klassischen Grundstückskäufen relevant. Sie spielt insbesondere bei Share-Deals, Konzernumstrukturierungen, gesellschaftsrechtlichen Beteiligungsänderungen und komplexen Immobilientransaktionen eine zentrale Rolle.
...
1. Welcher grunderwerbsteuerliche Tatbestand des § 1 GrEStG kann erfüllt sein?
2. Liegt ein Asset-Deal oder ein Share-Deal vor?
3. Sind Beteiligungsgrenzen und mittelbare Beteiligungsänderungen betroffen?
4. Kommen Befreiungen nach §§ 5, 6 oder 6a GrEStG in Betracht?
5. Welche Vor- und Nachbehaltensfristen gelten?
6. Ist die Einhaltung einer Frist rechtlich unmöglich oder lediglich tatsächlich nicht erfolgt?
7. Bilden Grundstückskauf und Bauvertrag einen einheitlichen Erwerbsgegenstand?
8. Ist der Erwerber hinsichtlich des Ob und Wie der Bebauung tatsächlich frei?
9. Sind Nutzungsrechte bereits wirksam im Grundbuch eingetragen?
10. Handelt es sich um eine dauernde Last?
11. Wurde die Gegenleistung nachträglich herabgesetzt?
12. Liegt eine echte rechtliche und faktische Lösung vom ursprünglichen Bauvertrag vor?
13. Kann § 16 GrEStG bei Rücktritt, Widerruf oder Rückübertragung angewendet werden?
14. Wurden alle Anzeige- und Erklärungspflichten fristgerecht erfüllt?
...
KNOWLEDGE_BASE.push(grunderwerbsteuerAktuelleEntwicklung2026Rechtsprechung);
