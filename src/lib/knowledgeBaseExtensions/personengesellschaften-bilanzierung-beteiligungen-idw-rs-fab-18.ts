...
export const personengesellschaftenBilanzierungBeteiligungen: KBEntry = {
  id: "personengesellschaften-bilanzierung-beteiligungen-idw-rs-fab-18",
  title: "Bilanzierung von Beteiligungen an Personengesellschaften",
  short:
...
1. Erfolgswirksame Ausschüttung
Die Auszahlung stammt aus laufenden oder während der Beteiligungsdauer thesaurierten Gewinnen. Sie wird als Beteiligungsertrag erfasst.

2. Erfolgsneutrale Kapitalrückzahlung
Die Auszahlung stellt wirtschaftlich eine Rückgewähr von Einlagen oder bereits beim Erwerb vorhandener Substanz dar. Sie mindert den Beteiligungsbuchwert.

3. Gemischte Auskehrung
Eine Zahlung kann teilweise Beteiligungsertrag und teilweise Kapitalrückzahlung sein. Das gilt insbesondere, wenn seit dem Erwerb über mehrere Jahre Gewinne thesauriert und zugleich frühere Vermögensbestandteile ausgekehrt wurden.

Aus Vorsichtsgründen kann im Zweifelsfall auch eine vollständig erfolgsneutrale Behandlung sachgerecht sein.

Beispiel:
Eine GmbH hält 30 % an einer OHG. Seit dem Erwerb wurden der GmbH anteilig 300.000 € thesaurierte Gewinne zugerechnet. Später erhält sie eine Auszahlung von 450.000 €. Dann können 300.000 € als Beteiligungsertrag und 150.000 € als Minderung des Beteiligungsbuchwerts erfasst werden.
...
Beispiel:
Ein Gewinnanteil von 100.000 € wird steuerlich bereits zum 31.12. erfasst, handelsrechtlich aber erst im Folgejahr. Bei einem erwarteten Steuersatz von 30 % kann eine aktive latente Steuer von 30.000 € angesetzt werden. Sie ist bei handelsrechtlicher Erfassung des Gewinns wieder aufzulösen.
...
1. Wo ist die Beteiligung nach § 266 HGB auszuweisen?
2. Welche Aufwendungen gehören zu den Anschaffungskosten?
3. Liegt eine dauerhafte oder nur vorübergehende Wertminderung vor?
4. Wann entsteht der Gewinnanspruch nach Gesellschaftsvertrag und Beschlusslage?
5. Ist eine Auszahlung Gewinn, Kapitalrückzahlung oder eine Kombination?
6. Handelt es sich um eine transparent besteuerte oder optierte Personengesellschaft?
7. Weichen Beteiligungsbuchwert und steuerliches Kapitalkonto voneinander ab?
8. Sind aktive oder passive latente Steuern nach § 274 HGB zu erfassen?
9. Müssen bestehende Steuerlatenzen wegen einer Option nach § 1a KStG neu beurteilt werden?
...
if (!KNOWLEDGE_BASE.some((entry) => entry.id === personengesellschaftenBilanzierungBeteiligungen.id)) {
  KNOWLEDGE_BASE.push(personengesellschaftenBilanzierungBeteiligungen);
}
