...
export const personengesellschaftenGrundlagen: KBEntry = {
  id: "personengesellschaften-grundlagen-steuerliche-besonderheiten",
  title: "Personengesellschaften: Was ist steuerlich zu beachten?",
  short:
  ...
  source:
    "Eigenständig zusammengefasste Darstellung auf Grundlage des EStG, GewStG und der AO; Rechtsstand 2026.",
  keywords:
    "personengesellschaft|personengesellschaften|was ist bei personengesellschaften zu beachten|personengesellschaft genau beachten|mitunternehmerschaft|mitunternehmer|ohg|kg|gbr|gmbh & co. kg|gewinnverteilung|sondervergütung|sonderbetriebsvermögen|gesonderte und einheitliche feststellung|gewerbesteueranrechnung",
  references: [
...
Bei einer Personengesellschaft sollten mindestens folgende Punkte geprüft werden:
1. Liegt eine steuerliche Mitunternehmerschaft vor?
2. Wie lautet der allgemeine Gewinnverteilungsschlüssel?
3. Gibt es Vorabgewinne oder Sondervergütungen?
4. Besteht Sonderbetriebsvermögen?
5. Sind Ergänzungsbilanzen erforderlich?
6. Wie werden Gewerbesteuer und § 35 EStG verteilt?
7. Sind Gesellschafterwechsel oder Anteilsübertragungen erfolgt?
8. Welcher Bescheid ist bei einem Fehler anzufechten?

Merksatz:
Bei Personengesellschaften werden Gewinn und Einkommensteuer den Gesellschaftern zugerechnet, während die Gewerbesteuer grundsätzlich bei der Gesellschaft entsteht. Sondervergütungen, Sonderbetriebsvermögen und das Feststellungsverfahren müssen deshalb immer mitgeprüft werden.
...
if (!KNOWLEDGE_BASE.some((entry) => entry.id === personengesellschaftenGrundlagen.id)) {
  KNOWLEDGE_BASE.push(personengesellschaftenGrundlagen);
}
