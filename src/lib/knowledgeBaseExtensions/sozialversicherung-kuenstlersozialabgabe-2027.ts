...
export const sozialversicherungKuenstlersozialabgabe2027: KBEntry = {
  id: "sozialversicherung-kuenstlersozialabgabe-2027",
  title: "Künstlersozialabgabe 2027: Abgabesatz soll auf 5,0 % steigen",
  short:
  ...
  keywords:
    "künstlersozialabgabe 2027|kuenstlersozialabgabe 2027|künstlersozialversicherung|kuenstlersozialversicherung|ksk|ksa|5,0 prozent|4,9 prozent|selbständige künstler|publizisten|verwerter|künstlersozialkasse|abgabesatz 2027",
  references: [
    "Künstlersozialversicherungsgesetz",
    "Künstlersozialabgabe-Verordnung 2027 – Entwurfsstand",
    "BMAS, Pressemitteilung vom 03.07.2026",
  ],
  importance: 4,
  body: `Der Abgabesatz zur Künstlersozialversicherung soll im Jahr 2027 von 4,9 % auf 5,0 % steigen. Das Bundesministerium für Arbeit und Soziales hat hierzu die Ressort- und Verbändebeteiligung für die Künstlersozialabgabe-Verordnung 2027 eingeleitet.

Unterkategorie: Künstlersozialversicherung

1. Was ist die Künstlersozialversicherung?
...
Beispiel:
Ein abgabepflichtiges Unternehmen zahlt im Jahr 2027 insgesamt 20.000 € an selbständige Künstler oder Publizisten.

Künstlersozialabgabe bei 5,0 %:
20.000 € × 5,0 % = 1.000 €
...
1. welche Zahlungen im Jahr 2027 voraussichtlich an selbständige Kreative geleistet werden,
2. ob eine Abgabepflicht dem Grunde nach besteht,
3. ob die Entgelte vollständig dokumentiert werden,
4. ob Verträge und Rechnungen die Art der Leistung eindeutig erkennen lassen und
5. ob bei der Budgetplanung bereits mit dem Satz von 5,0 % gerechnet werden sollte.

Kurzformel:
Abgabepflichtige Entgelte × Abgabesatz = Künstlersozialabgabe

Stand: Juli 2026. Das weitere Verordnungsverfahren ist zu beobachten.`,
};

if (!KNOWLEDGE_BASE.some((entry) => entry.id === sozialversicherungKuenstlersozialabgabe2027.id)) {
  KNOWLEDGE_BASE.push(sozialversicherungKuenstlersozialabgabe2027);
}
