...
export const sozialversicherungUnfallversicherungHomeoffice2026: KBEntry = {
  id: "sozialversicherung-unfallversicherung-homeoffice-mobiles-arbeiten-mittagspause-2026",
  title: "Unfallversicherung im Homeoffice: Wege zum Mittagessen",
  short:
  ...
  keywords:
    "arbeitsunfall homeoffice|unfallversicherung homeoffice|mobiles arbeiten unfall|mittagspause arbeitsunfall|weg zum imbiss|betriebsweg|arbeitsweg|handlungstendenz|betriebsbedingtheit|außentür wohnhaus|l 3 u 189/24|l 3 u 176/25|b 2 u 8/26 r|b 2 u 9/26 r",
  references: [
    "Hessisches LSG, Urteil vom 28.04.2026 – L 3 U 189/24",
    "Hessisches LSG, Urteil vom 19.05.2026 – L 3 U 176/25",
    "BSG – B 2 U 8/26 R",
    "BSG – B 2 U 9/26 R",
  ],
  importance: 4,
  body: `Auch bei einer Tätigkeit im Homeoffice oder an einem frei gewählten mobilen Arbeitsort können Wege in der Mittagspause unter dem Schutz der gesetzlichen Unfallversicherung stehen. Entscheidend ist jedoch nicht allein, dass während des Arbeitstags ein Unfall geschieht. Der konkrete Weg muss ausreichend mit der versicherten Tätigkeit verbunden sein.
...
1. Handlungstendenz
Der Weg muss dazu dienen, die Arbeitsfähigkeit zu erhalten und anschließend die betriebliche Tätigkeit fortzusetzen.

2. Betriebsbedingtheit
Der Weg muss gerade deshalb zurückgelegt werden, weil die versicherte Person in die betriebliche Tätigkeit und Arbeitsorganisation eingebunden ist.
...
1. Bestand eine versicherte Beschäftigung?
2. War der konkrete Ort als Homeoffice oder mobiler Arbeitsort betrieblich akzeptiert?
3. Wohin führte der Weg und wo begann er?
4. Wollte die versicherte Person ihre Arbeitskraft erhalten und danach weiterarbeiten?
5. Bestand eine tatsächliche Einbindung in Termine, Pausenzeiten oder sonstige betriebliche Abläufe?
6. Wäre der Weg auch ohne das private Bedürfnis nach Essen zurückgelegt worden?
7. War die Nahrungsbeschaffung noch plausibel auf die Fortsetzung des Arbeitstags gerichtet?
...
if (!KNOWLEDGE_BASE.some((entry) => entry.id === sozialversicherungUnfallversicherungHomeoffice2026.id)) {
  KNOWLEDGE_BASE.push(sozialversicherungUnfallversicherungHomeoffice2026);
}
