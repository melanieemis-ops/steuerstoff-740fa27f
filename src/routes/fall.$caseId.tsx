          ...
          <div className="mt-4 flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
            <div className="min-w-0">
              <div className="flex flex-wrap items-center gap-1.5">
                ...
                <span className="inline-flex items-center gap-1 rounded border border-border bg-background px-1.5 py-0.5 text-[10px] uppercase tracking-wide text-muted-foreground">
                  {a.kind === "wissen" || a.knowledge ? <BookOpen className="h-3 w-3" /> : null}
                  {KIND_LABEL[a.kind]}
                </span>
              </div>
              <h1
              ...
              <div className="mt-6 rounded-2xl border border-border bg-card p-5 shadow-card-soft">
                ...
                {a.knowledge.references?.length ? (
                  <div className="mt-3 flex flex-wrap gap-1.5">
                    {a.knowledge.references.map((ref) => (
                      <span
                        key={ref}
                        className="rounded border border-border bg-background px-1.5 py-0.5 text-[10px] uppercase tracking-wide text-muted-foreground"
                      >
                        {ref}
                      </span>
                    ))}
